...
var SplitterPanel = function(_Component) {
  _inherits(SplitterPanel2, _Component);
  var _super = _createSuper(SplitterPanel2);
  function SplitterPanel2() {
    _classCallCheck(this, SplitterPanel2);
    return _super.apply(this, arguments);
  }
  return _createClass(SplitterPanel2);
...
var Splitter = function(_Component2) {
  _inherits(Splitter2, _Component2);
  var _super2 = _createSuper(Splitter2);
  function Splitter2() {
    _classCallCheck(this, Splitter2);
    return _super2.apply(this, arguments);
  }
  _createClass(Splitter2, [{
    ...
    value: function renderPanel(panel, index) {
      ...
      var gutter = index !== this.props.children.length - 1 && import_react.default.createElement("div", {
        ref: function ref(el) {
    ...
    value: function renderPanels() {
      var _this5 = this;
      return import_react.default.Children.map(this.props.children, function(panel, index) {
